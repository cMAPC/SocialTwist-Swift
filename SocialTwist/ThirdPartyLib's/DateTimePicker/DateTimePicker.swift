...
//            todayButton.setTitleColor(highlightColor, for: .normal)
    ...
    private func configureView() {
        ...
        borderTopView = UIView(frame: CGRect(x: 0, y: 0, width: contentView.frame.width, height: 1))
        borderTopView.backgroundColor = darkColor.withAlphaComponent(0.2)
        borderTopView.isHidden = isTimePickerOnly
        contentView.addSubview(borderTopView)
        
        borderBottomView = UIView(frame: CGRect(x: 0, y: dayCollectionView.frame.origin.y + dayCollectionView.frame.height, width: contentView.frame.width, height: 1))
        borderBottomView.backgroundColor = darkColor.withAlphaComponent(0.2)
        if isTimePickerOnly {
            borderBottomView.frame = CGRect(x: 0, y: dayCollectionView.frame.origin.y, width: contentView.frame.width, height: 1)
        }
        ...
        doneButton.frame = CGRect(x: 0, y: contentView.frame.height - 122, width: contentView.frame.width, height: 44)
        doneButton.setTitle(doneButtonTitle, for: .normal)
        ...
        hourTableView.backgroundColor = UIColor.clear
        ...
        minuteTableView.backgroundColor = UIColor.clear
        ...
        amPmTableView.backgroundColor = UIColor.clear
        ...
        colonLabel1.center = CGPoint(x: contentView.frame.width / 2 + extraSpace,
                                     y: (borderBottomView.frame.origin.y) / 2 + borderBottomView.frame.origin.y)
        colonLabel1.text = ":"
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|[v0]|", options: [], metrics: nil, views: ["v0": contentView]))
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[v0]|", options: [], metrics: nil, views: ["v0": contentView]))
